...
<body>
    <section class="container-fliud main-dashboard">
        ...
        <div class="d-flex justify-content-between">
            <h4>Admins</h4>
            <a href="assets/includes/create-admin.php">
                <img src="assets/img/add-user.png" width="30" height="30" alt="">
            </a>
        </div><hr>
        ...
        if ($result = mysqli_query($link, $sql)) {
            if (mysqli_num_rows($result) > 0) {
                ...
                echo "<table class='table table-bordered table-striped table-light text-center' id='myTable1'>";
                echo "<thead>";
                echo "<tr>";
        ...
        <div class="d-flex justify-content-between m-t-90">
            <h4>Users</h4>
            <a href="assets/includes/create.php">
                <img src="assets/img/add-user.png" width="30" height="30" alt="">
            </a>
        </div><hr>
        <div id="filter-search">
