    ...
    if ($stmt = mysqli_prepare($link, $sql)) {
        ...
        if (mysqli_stmt_execute($stmt)) {
            ...
            if (mysqli_num_rows($result) == 1) {
                ...
                header("location: admin-profile.php?error");
                exit();
            }
        } else {
...
<body>
    ...
    if ($row["img"] == true) {
        echo "<img class='rounded-circle box-shadow' src='assets/img/admins/" . $row['img'] . "'  width='100px' height='100px'>";
    } else {
        echo "<img class='rounded-circle box-shadow' src='assets/img/user.png' width='100px' height='100px'>";
    }

    ?>
				<h4 class="alert alert-success m-t-20 text-uppercase"><b><?php echo $row["name"]; ?></b></h4>
